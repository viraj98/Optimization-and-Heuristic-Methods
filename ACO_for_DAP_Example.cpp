...
{
	// Initialization.
	long N,itterations,INF = 99999999;
	...
	vector <double> S1{250,350};
	vector <double> CD1{150,80,100,270};
	vector <vector <double> > C_PD1{{10,25,30},{5,35,14}};
	vector <vector <double> > FC_PD1{{1000,400,1150},{900,200,1300}};
	vector <vector <double> > C_DR1{{43,25,10,50},{20,5,0,30},{60,32,50,40}};
	vector <vector <double> > FC_DR1{{500,1200,800,2000},{2250,1500,0,2000},{400,1800,2300,1000}};
